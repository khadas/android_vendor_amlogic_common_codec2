...
func c2_amlDefaults(ctx android.LoadHookContext) {
    //sdkVersion,_ := strconv.Atoi(ctx.DeviceConfig().PlatformVndkVersion())
...
func init() {
    android.RegisterModuleType("c2_aml_defaults", c2_amlFactory)
}

func c2_amlFactory() android.Module {
    module := cc.DefaultsFactory()
    android.AddLoadHook(module, c2_amlDefaults)
