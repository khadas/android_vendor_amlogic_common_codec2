...
class C2SoftVdecComponent
        : public C2Component, public std::enable_shared_from_this<C2SoftVdecComponent> {
public:
    explicit C2SoftVdecComponent(
            const std::shared_ptr<C2ComponentInterface> &intf);
    virtual ~C2SoftVdecComponent();
...
private:
    ...
    public:
        ...
        void setComponent(const std::shared_ptr<C2SoftVdecComponent> &thiz);

    protected:
        void onMessageReceived(const sp<AMessage> &msg) override;

    private:
        std::weak_ptr<C2SoftVdecComponent> mThiz;
        bool mRunning;
    };
