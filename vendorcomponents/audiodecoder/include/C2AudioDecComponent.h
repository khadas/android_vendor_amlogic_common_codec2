...
#ifndef C2_AUDIO_DEC_COMPONENT_H_
#define C2_AUDIO_DEC_COMPONENT_H_
...
class C2AudioDecComponent
        : public C2Component, public std::enable_shared_from_this<C2AudioDecComponent> {
public:
    explicit C2AudioDecComponent(
            const std::shared_ptr<C2ComponentInterface> &intf);
    virtual ~C2AudioDecComponent();
...
private:
    ...
    public:
        ...
        void setComponent(const std::shared_ptr<C2AudioDecComponent> &thiz);

    protected:
        void onMessageReceived(const sp<AMessage> &msg) override;

    private:
        std::weak_ptr<C2AudioDecComponent> mThiz;
        bool mRunning;
    };
    ...
    C2AudioDecComponent() = delete;
};

}  // namespace android

#endif  // C2_AUDIO_DEC_COMPONENT_H_
