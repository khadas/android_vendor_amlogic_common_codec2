...
//#define LOG_NDEBUG 0
#define LOG_TAG "C2AudioDecInterface"
#include <utils/Log.h>
...
C2AudioDecInterface<void>::BaseParams::BaseParams(
...
void C2AudioDecInterface<void>::BaseParams::noInputLatency() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noOutputLatency() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noPipelineLatency() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noPrivateBuffers() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noInputReferences() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noOutputReferences() {
    addParameter(
...
void C2AudioDecInterface<void>::BaseParams::noTimeStretch() {
    addParameter(
